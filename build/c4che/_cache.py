...
CFLAGS_PYEMBED = ['-fno-strict-aliasing', '-fdebug-prefix-map=/build/python2.7-jgBwco/python2.7-2.7.15=.', '-fstack-protector-strong', '-fwrapv']
CFLAGS_PYEXT = ['-fno-strict-aliasing', '-fdebug-prefix-map=/build/python2.7-jgBwco/python2.7-2.7.15=.', '-fstack-protector-strong', '-fwrapv']
CFLAGS_cshlib = ['-fPIC']
COMPILER_CC = 'gcc'
COMPILER_CXX = 'g++'
CPPPATH_ST = '-I%s'
...
CXXFLAGS_PYEMBED = ['-fno-strict-aliasing', '-fdebug-prefix-map=/build/python2.7-jgBwco/python2.7-2.7.15=.', '-fstack-protector-strong', '-fwrapv']
CXXFLAGS_PYEXT = ['-fno-strict-aliasing', '-fdebug-prefix-map=/build/python2.7-jgBwco/python2.7-2.7.15=.', '-fstack-protector-strong', '-fwrapv', '-fvisibility=hidden', '-Wno-array-bounds']
...
ENABLE_GTK2 = '-pthread -I/usr/include/gtk-2.0 -I/usr/lib/x86_64-linux-gnu/gtk-2.0/include -I/usr/include/gio-unix-2.0/ -I/usr/include/cairo -I/usr/include/pango-1.0 -I/usr/include/atk-1.0 -I/usr/include/cairo -I/usr/include/pixman-1 -I/usr/include/gdk-pixbuf-2.0 -I/usr/include/libpng16 -I/usr/include/pango-1.0 -I/usr/include/harfbuzz -I/usr/include/pango-1.0 -I/usr/include/glib-2.0 -I/usr/lib/x86_64-linux-gnu/glib-2.0/include -I/usr/include/fribidi -I/usr/include/uuid -I/usr/include/freetype2 -I/usr/include/libpng16 -lgtk-x11-2.0 -lgdk-x11-2.0 -lpangocairo-1.0 -latk-1.0 -lcairo -lgdk_pixbuf-2.0 -lgio-2.0 -lpangoft2-1.0 -lpango-1.0 -lgobject-2.0 -lglib-2.0 -lfribidi -lfontconfig -lfreetype\n'
...
EXAMPLE_DIRECTORIES = ['socket', 'wireless', 'udp-client-server', 'routing', 'tcp', 'error-model', 'energy', 'tutorial', 'udp', 'realtime', 'traffic-control', 'matrix-topology', 'ipv6', 'stats', 'naming']
...
INCLUDES_GTK2 = ['/usr/include/gtk-2.0', '/usr/lib/x86_64-linux-gnu/gtk-2.0/include', '/usr/include/gio-unix-2.0/', '/usr/include/cairo', '/usr/include/pango-1.0', '/usr/include/atk-1.0', '/usr/include/pixman-1', '/usr/include/gdk-pixbuf-2.0', '/usr/include/libpng16', '/usr/include/harfbuzz', '/usr/include/glib-2.0', '/usr/lib/x86_64-linux-gnu/glib-2.0/include', '/usr/include/fribidi', '/usr/include/uuid', '/usr/include/freetype2']
...
LIB_GTK2 = ['gtk-x11-2.0', 'gdk-x11-2.0', 'pangocairo-1.0', 'atk-1.0', 'cairo', 'gdk_pixbuf-2.0', 'gio-2.0', 'pangoft2-1.0', 'pango-1.0', 'gobject-2.0', 'glib-2.0', 'fribidi', 'fontconfig', 'freetype']
LIB_LIBXML2 = ['xml2']
...
NS3_EXECUTABLE_PATH = ['/home/limemnghui/ns-allinone-3.27/ns-3.27/build/src/fd-net-device', '/home/limemnghui/ns-allinone-3.27/ns-3.27/build/src/tap-bridge']
...
VALGRIND_FOUND = True
VERSION = '3.27'
WITH_PYBINDGEN = '/home/limemnghui/ns-allinone-3.27/pybindgen-0.17.0.post58+ngcf00cc0'
WL_SONAME_SUPPORTED = True
cfg_files = ['/home/limemnghui/ns-allinone-3.27/ns-3.27/build/ns3/config-store-config.h', '/home/limemnghui/ns-allinone-3.27/ns-3.27/build/ns3/core-config.h']
cprogram_PATTERN = '%s'
